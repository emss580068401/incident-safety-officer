/**
 * ISO Tactical Manual - ULTIMATE VERBATIM EDITION v1.0
 * 100% Content Retention (723 Lines Exhaustive Restoration)
 * Tactical Black / High-Visibility / Zero Content Loss
 */
...
window.onload = () => {
    ...
    // --- Content Database (Ultimate Verbatim v1.0) ---
    const pagesData = [
        // [0] Cover
        ...
        // [1] Chief & Sec Chief Words (Merged Verbatim)
        `<div class="page">
        ...
        // [4] Part 1: ICS Positioning (Verbatim)
        `<div class="page">
        ...
        // [11] 3.2 Risk Balance (VERBATIM RESTORED)
        `<div class="page">
        ...
        // [12] 3.3 Brake & MEDIC Mantra (VERBATIM RESTORED)
        `<div class="page">
        ...
        // [13] Ch 4: Smoke Reading (VVCD Scoring Dashboard - HIGH VISIBILITY)
        `<div class="page">
        ...
        // [20] TIC Table (High Visibility - Verbatim)
        `<div class="page">
        ...
        // [22] 8.3 Retreat & Case A (Verbatim)
        `<div class="page">
            <h4>8.3 撤退信號：長笛三聲</h4>
        ...
        // [25] Appendix: Pocket Card (ULTIMATE VERBATIM 1-5)
        ...
        // [26] Module: Iron Flow (VERBATIM 100%)
        `<div class="page centered">
        ...
        // [27] Module: Chem Flow (VERBATIM 100%)
        `<div class="page centered">
        ...
        // [28] Module: Mayday Flow (VERBATIM 100%)
        `<div class="page centered">
        ...
        // [29] Appendix: Handover (HIGH VISIBILITY)
        `<div class="page">
    ...
    pagesData.forEach(p => { bookElement.insertAdjacentHTML('beforeend', p); });
    ...
    flipBook.on('flip', (e) => {
        ...
        pageInfo.textContent = `${pageIdx + 1} / ${pagesData.length}`;
        navItems.forEach(nav => {
            const target = parseInt(nav.getAttribute('data-page'));
            if (target === pageIdx) nav.classList.add('active');
    ...
    if (window.mermaid) mermaid.init(undefined, document.querySelectorAll('.mermaid'));
    pageInfo.textContent = `1 / ${pagesData.length}`;
};